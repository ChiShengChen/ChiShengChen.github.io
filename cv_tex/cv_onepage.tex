...
\resumeSubHeadingListStart
  \resumeEduHeading
    ...
    {M.S., Biomedical Electronics \& Bioinformatics — Adv.\ Prof.\ Cheng-Ta Li, MD \& Prof.\ Chung-Ping Chen}{Sep 2019 -- Jun 2021}
  \resumeEduHeading
...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    ...
    {Fractional Token Efficiency Research Lead (Advisor)}{Aug 2026 -- Now}
    \resumeItemListStart
      \resumeItem{Advising the AI $\times$ quant-trading division of Taiwan's leading HFT prop firm on LLM token-efficiency research, multi-agent architecture, and financial data extraction.}
    \resumeItemListEnd
  \resumeSubheading
...
%---------- PUBLICATIONS ----------
\section{Selected Publications \hfill \normalfont\small (first/co-first author unless noted; 49 papers, 474 cites, h-index 13 --- full list on Google Scholar)}
\resumeSubHeadingListStart
  \small{\item{
    \textit{Biosignals \& Physiological Time-Series ML.}\\ \vspace{1pt}
    \textbf{Chen, C.-S., et al.} ``FreqLens: Interpretable Frequency Attribution for Time Series Forecasting.'' \textit{Under review, ICLR 2027}; arXiv:2602.08768. \\ \vspace{2pt}
    ...
    \textbf{Chen, C.-S., et al.} ``A Unified SPD Token Transformer Framework for EEG Classification.'' \textit{Under review, Neurocomputing}; arXiv:2601.21521. \\ \vspace{2pt}
    \textbf{Chen, C.-S.}, Wei, C.-S. ``Mind's Eye: Image Recognition by EEG via Multimodal Similarity-Keeping Contrastive Learning.'' \textit{arXiv:2406.16910} (2024) --- 32 cites. \\ \vspace{2pt}
    ...
    \textbf{Chen, C.-S.}, Brat, G.A. ``Measuring Browser Webcam Gaze Honestly: A Capture-Clock Methodology.'' \textit{MICCAI DEMI Workshop} (2026, poster). \\ \vspace{2pt}
    ...
    \textbf{Chen, C.-S., et al.} ``QEEGNet: Quantum Machine Learning for Enhanced EEG Encoding.'' \textit{J.\ Signal Processing Systems} (2025); SiPS 2024 --- 64 cites. \\ \vspace{2pt}
    ...
    \textbf{Chen, C.-S., et al.} ``Res-VMamba: Fine-Grained Food Classification via Selective State-Space Models with Deep Residual Learning.'' \textit{arXiv:2402.15761} (2024); \textit{PLoS ONE} (2025) --- 81 cites.
  }}
\resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
  \small{\item{
    ...
    \textbf{Journal Reviewer (39 journals):} incl.\ TPAMI, TNNLS, IEEE JBHI, National Science Review (OUP), npj Quantum Information, Scientific Reports, Elsevier Neural Networks. \quad \textbf{PC:} QNRL @ IEEE WCCI 2026.
  }}
\resumeSubHeadingListEnd
