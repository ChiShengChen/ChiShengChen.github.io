...
\resumeSubHeadingListStart
  \resumeEduHeading
    ...
    {M.S., Computer Science \& Bioinformatics (GPA 3.74/4.30) — Adv.\ Prof.\ Cheng-Ta Li, MD \& Prof.\ Chung-Ping Chen}{Sep 2019 -- Jun 2021}
  \resumeEduHeading
...
%---------- PUBLICATIONS ----------
\section{Selected Publications \hfill \normalfont\small (first/co-first author unless noted; 45 papers, 416+ cites, h-index 12 --- full list on Google Scholar)}
\resumeSubHeadingListStart
  \small{\item{
    ...
    \textbf{Chen, C.-S.}, Wei, C.-S. ``Mind's Eye: Image Recognition by EEG via Multimodal Similarity-Keeping Contrastive Learning.'' \textit{arXiv:2406.16910} (2024) --- 28 cites. \\ \vspace{2pt}
    ...
    \textbf{Chen, C.-S., et al.} ``QEEGNet: Quantum Machine Learning for Enhanced EEG Encoding.'' \textit{J.\ Signal Processing Systems} (2025); SiPS 2024 --- 48 cites. \\ \vspace{2pt}
    ...
    \textbf{Chen, C.-S., et al.} ``Res-VMamba: Fine-Grained Food Classification via Selective State-Space Models with Deep Residual Learning.'' \textit{arXiv:2402.15761} (2024) --- 62 cites.
  }}
\resumeSubHeadingListEnd
...
\resumeSubHeadingListStart
  \small{\item{
    ...
    \textbf{Journal Reviewer (33 journals):} incl.\ TPAMI, TNNLS, IEEE JBHI, National Science Review (OUP), npj Quantum Information, Scientific Reports, Elsevier Neural Networks. \quad \textbf{PC:} QNRL @ IEEE WCCI 2026.
  }}
\resumeSubHeadingListEnd
