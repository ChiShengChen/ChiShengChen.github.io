...
%---------- PUBLICATIONS ----------
\section{Selected Publications \hfill \normalfont\small (first/co-first author; full list on Google Scholar)}
\resumeSubHeadingListStart
  \small{\item{
    ...
    \textbf{Chen, C.-S., et al.} ``QEEGNet: Cross-Task \& Cross-Dataset EEG Encoding with Quantum ML.'' \textit{J.\ Signal Processing Systems} (2025); SiPS 2024. \\ \vspace{2pt}
    ...
    Li, C.-T., \textbf{Chen, C.-S.}, et al. ``Prediction of Antidepressant Responses to Non-Invasive Brain Stimulation from Frontal EEG.'' \textit{J.\ Affective Disorders} (2023, IF 6.5).
  }}
\resumeSubHeadingListEnd
